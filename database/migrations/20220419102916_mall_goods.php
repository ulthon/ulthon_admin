...
class MallGoods extends Migrator
{
    ...
    public function change()
    {
        $table = $this->table('mall_goods')
            ...
            ->addColumn(Column::text('images')->setNullable()->setComment('商品图片 {images}'))
            ->addColumn(Column::text('describe')->setNullable()->setComment('商品描述 {editor}'))
            ->addColumn(Column::text('property')->setNullable()->setComment('商品属性'))
